...
[0] = LAYOUT(
	KC_G,	KC_T,	KC_R,	KC_NO,	KC_F,	KC_4,	KC_V,	KC_B,
	KC_BSLS,	KC_NO,	KC_W,	KC_NO,	KC_S,	KC_2,	KC_X,	KC_NO,
	KC_NO,	KC_NO,	KC_E,	KC_NO,	KC_D,	KC_3,	KC_C,	KC_NO,
	KC_NO,	KC_TAB,	KC_Q,	KC_GRAVE,	KC_A,	KC_1,	KC_NO,	KC_NO,
	KC_NO,	KC_NO,	KC_PGUP,	KC_NO,	KC_PGDN,	KC_LWIN,	KC_NO,	KC_NO,

	KC_NO,	KC_NO,	KC_NO,	KC_NO,	MO(0),	KC_NO,	KC_NO,	KC_NO,
	...
	KC_NO,	KC_LBRC,	KC_P,	KC_MINUS,	KC_SCLN,	KC_0,	KC_NUHS,	KC_SLSH,
	...
	KC_NO,	KC_NO,	KC_NO,	KC_NO,	KC_NO,	KC_NO,	KC_NO,	KC_NO
        ...
        // KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_INS, KC_DEL, KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT, KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(1), KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RCTL, KC_NO, KC_PGUP, KC_UP, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT),
    // [1] = LAYOUT_iso(KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_F4, BL_STEP, KC_BRID, KC_BRIU, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_INS, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PSLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PAST, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P1, KC_P2, KC_P3, KC_PMNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P0, KC_NO, KC_PDOT, KC_PPLS, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_APP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
